...
def get_rec(coordinate, num_list):
    x_cor = [coordinate[num_list[0]][0], coordinate[num_list[1]][0], coordinate[num_list[2]][0], coordinate[num_list[3]][0]]
    y_cor = [coordinate[num_list[0]][1], coordinate[num_list[1]][1], coordinate[num_list[2]][1], coordinate[num_list[3]][1]]
...
def conver1(coordinates):
    ...
    out_img = cv2.seamlessClone(lefteyeimg, out_img, mask1, center1, cv2.NORMAL_CLONE)
    out_img = cv2.seamlessClone(righteyeimg, out_img, mask2, center2, cv2.NORMAL_CLONE)
    out_img = cv2.seamlessClone(mouthimg, out_img, mask3, center3, cv2.NORMAL_CLONE)
